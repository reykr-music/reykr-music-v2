...
// 	);
	...
	wp_enqueue_script(
	'smoothScroll',
	"http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://cdn.jsdelivr.net/gh/cferdinandi/smooth-scroll/dist/smooth-scroll.polyfills.min.js",
	false, //dependencies
  	null, //version number
  	true //load in footer
);
...
wp_enqueue_script(
	'animateOnScroll',
	"http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://unpkg.com/aos@2.3.1/dist/aos.js",
	false, //dependencies
  	null, //version number
  	true //load in footer
);
